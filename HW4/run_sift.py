...
from SFM import sift, knnmatch, find_matches, compute_essential_normalized, compute_P_from_essential
from SFM import reconstruct_one_point, linear_triangulation
...
if __name__ == "__main__":
    for key, value in DATA_path.items():
        ...
        # Trail
        # obj_main(best_wp, x1[:, :2], k1, f"./data/{file_name[0]}", 1)
